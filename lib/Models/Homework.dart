...
class Homework {
  ...
  Homework({this.id, this.date, this.idShedule, this.subject, this.content, this.grade, this.isDone = false, this.common = false});
  
  factory Homework.fromMap(Map<String, dynamic> json) => Homework(
    id: json['id'] == null ? null: int.parse(json['id'].toString()),
    date: int.parse(json['date'].toString()),
    idShedule: int.parse(json['idShedule'].toString()),
